...
extern volatile int8_t active_row;
...
//	  print_msg("COL3 Interrupt\r\n");
  ...
  // Just set the flag - DO NOT PRINT HERE
  if(active_row >= 0 && current_col >= 0 && pending_key == '\0') {
      pending_key = keypad[active_row][current_col];
  }
...
void EXTI15_10_IRQHandler(void)
{
  ...
  if (__HAL_GPIO_EXTI_GET_FLAG(USER_Btn_Pin)) {
	  ...
	  print_msg("Toggling LD1, Pack it Up\r\n");
